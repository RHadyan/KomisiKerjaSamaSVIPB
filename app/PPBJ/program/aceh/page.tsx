...
const App = () => {
  ...
  const handleRegistrationClick = () => {
    if (hasCheckedItems) {
      ...
      window.open(`https://wa.me/6287827760883?text=${encodeURIComponent(message)}`, '_blank');
    } else {
      // Default action jika belum ada yang diceklis (misal ke form pendaftaran atau WA umum)
      window.open(`https://wa.me/6287827760883?text=${encodeURIComponent("Halo Admin, saya ingin mendaftar program SSW.")}`, '_blank');
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl tracking-tight">PM Aceh <span style={{color: primaryColor}}>SSW</span></span>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-50 border border-pink-100">
              ...
              <span className="text-sm font-semibold uppercase tracking-wider text-[#f6399f]">Pendaftaran Dibuka - Batch 2024</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          <div className="col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg tracking-tight">PM Aceh <span style={{color: primaryColor}}>SSW</span></span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-500 text-sm">
              ...
              <li className="flex gap-2"><MessageCircle size={18} className="text-[#f6399f] flex-shrink-0" /> +62 812-XXXX-XXXX</li>
            </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto pt-16 mt-16 border-t border-gray-100 text-center text-sm text-gray-400">
          <p>© 2024 Pekerja Migran Aceh - Japan Preparation Program. All Rights Reserved.</p>
        </div>
      </footer>
